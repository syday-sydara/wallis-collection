...
export default function CartDrawer() {
  ...
  const desktopSidebar = (
    <div className="hidden lg:flex lg:flex-col lg:w-96 lg:border-l lg:border-[var(--color-border)] lg:bg-[var(--color-bg-surface)] lg:fixed lg:inset-y-0 lg:right-0 lg:z-40">
      ...
      {!isEmpty && (
        <div className="border-t border-[var(--color-border)] p-6 bg-[var(--color-bg-primary)]">
          <div className="flex justify-between mb-6">
            <span className="text-[var(--color-text-secondary)]">Subtotal ({itemCount})</span>
