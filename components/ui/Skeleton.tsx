...
const skeleton = cva("animate-shimmer bg-[color:var(--color-neutral-100)]", {
  variants: {
    shape: { block: "rounded-[var(--radius-sm)]", circle: "rounded-full", text: "h-4 rounded-sm" },
    size: { sm: "h-4 w-16", md: "h-6 w-32", lg: "h-8 w-64", full: "w-full h-6" },
  },
  defaultVariants: { shape: "block", size: "full" },
});
