export default function CartPageSkeleton() {
  return (
    <div className="animate-pulse container py-20 space-y-16">
      {/* Page Title */}
      <div className="h-10 w-40 bg-[var(--color-neutral)]/20 rounded-[var(--radius-md)]" />
      ...
      <div className="grid lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2 space-y-8">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="flex gap-6 border-b border-[var(--color-neutral)]/20 pb-8"
            >
              {/* Image Placeholder */}
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="h-10 w-full bg-[var(--color-neutral)]/10 rounded-[var(--radius-md)]" />
              </div>
            </div>
          ))}
        </div>
        ...
        {/* Summary Card */}
        <div className="border border-[var(--color-neutral)]/20 rounded-[var(--radius-xl)] p-6 shadow-soft space-y-6 h-fit">
          ...
          <div className="h-10 w-full bg-[var(--color-neutral)]/20 rounded-[var(--radius-md)]" />
        </div>
      </div>
    </div>
  );
